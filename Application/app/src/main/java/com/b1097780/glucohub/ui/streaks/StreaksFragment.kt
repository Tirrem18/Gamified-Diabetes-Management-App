...
import com.b1097780.glucohub.databinding.FragmentStreaksBinding
...
class StreaksFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val streaksViewModel =
            ViewModelProvider(this).get(StreaksViewModel::class.java)

        _binding = FragmentStreaksBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textStreaks
